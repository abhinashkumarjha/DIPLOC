...
<br>
<div id="subcontent">
<p><h2>Procedure to apply Gaussian Filter: </h2>
	<br>1. Choose an image file first..<br>
	<br>2. Select your image and then click on upload.<br>
	<br>3. Adjust your range.<br>
	<br>4. Click on Filter Image button to see the effects.<br>
...
-webkit-appearance: slider-horizontal" min="-1" max="1" id="kkk" value="0" step="0.2" onchange="channel(imgObj)" /><br>
</form>
<div id="output"></div>
