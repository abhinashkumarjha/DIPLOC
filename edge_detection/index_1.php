...
<br>
<div id="subcontent">
<p><h2>Procedure to detect edges: </h2>
	<br>1. Choose an image file first.<br>
	<br>2. Select your image and then click on upload.<br>
	<br>3. Adjust your range (Left: HORIZONTAL EDGE Right: VERTICAL EDGE).<br>
	<br>4. Click on Applying Sobel Operator button to see the effects.<br>
...
-webkit-appearance: slider-horizontal" min="4" max="10" id="kkk" value="7" step="3" onchange="channel(imgObj)" /><br>
</form>
<div id="output"></div>
