...
if(character == 10)
                 {
                var avg1= ( -imgPixels.data[i -(imgPixels.width-1)*4] +imgPixels.data[i +((imgPixels.width-1)*4)])  ;
                var avg2= ( -imgPixels.data[i -(imgPixels.width-1)*4 +1] +imgPixels.data[i +((imgPixels.width-1)*4)+1])  ;
				var avg3= ( -imgPixels.data[i -(imgPixels.width-1)*4+ 2] +imgPixels.data[i +((imgPixels.width-1)*4)+ 2])  ;
                src.data[i ] = avg1+127; 
				src.data[i + 1] = avg2+127; 
                src.data[i + 2] = avg3+127;
	
	
	}
                else if(character == "UR")
                 {
                var avg1= ( -imgPixels.data[i -((imgPixels.width-1)*4)+4] +imgPixels.data[i +((imgPixels.width-1)*4)-4])  ;
				var avg2= ( -imgPixels.data[i -((imgPixels.width-1)*4)+4 +1] +imgPixels.data[i +((imgPixels.width-1)*4)-4+1])  ;
				var avg3= ( -imgPixels.data[i -((imgPixels.width-1)*4)+4+2] +imgPixels.data[i +((imgPixels.width-1)*4)-4+2])  ;
                ...
                src.data[i + 2] = avg3+127;
                 ...
                 {
                var avg1= (imgPixels.data[i -4] -imgPixels.data[i +4])  ;
                var avg2= (imgPixels.data[i -4+1] -imgPixels.data[i +4+1])  ;
				var avg3= (imgPixels.data[i -4+2] -imgPixels.data[i +4+2])  ;
				src.data[i ] = avg1+127; 
				src.data[i + 1] = avg2+127; 
                src.data[i + 2] = avg3+127;
                 }
				 else if(character == "LR")
                 {
                var avg1= (imgPixels.data[i-((imgPixels.width-1)*4)-4] -imgPixels.data[i +((imgPixels.width-1)*4)+4])  ;
                var avg2= (imgPixels.data[i-((imgPixels.width-1)*4)-4+1] -imgPixels.data[i +((imgPixels.width-1)*4)+4+1])  ;
				var avg3= (imgPixels.data[i-((imgPixels.width-1)*4)-4+2] -imgPixels.data[i +((imgPixels.width-1)*4)+4+2])  ;
