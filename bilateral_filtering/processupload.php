...
<script> 
      ...
      function channel(imgObj)
    {
        ...
        for(var y = 0; y < imgPixels.height; y++){
            for(var x = 20; x < imgPixels.width-20; x++){
		        ...
		        var sm=0;
                 ...
                 for (var d = -20 ; d<21;d++){
				  ...
				  var a =Math.pow(Math.E,-d*d/50)     *   Math.pow(Math.E, -1* Math.pow(imgPixels.data[i+(d*4)]-imgPixels.data[i],2)/5000)   + .0001;
				 
                   s = s + a;
				   p = a * imgPixels.data[i+(d*4)];
				   sm = sm + p;
				  }
