...
<title>Minimising/Maximising</title>
...
<br>
<div id="subcontent">
<p><h2>Procedure to vary scaling: </h2>
	<br>1. Choose an image file first.<br>
	<br>2. Select your image and then click on upload.<br>
	<br>3. Adjust your scaling range.<br>
	<br>4. Click on Apply Scaling button to see the effects.<br>
...
-webkit-appearance: slider-horizontal" min="-10" max="10" id="kkk" value="0" step="1" onchange="channel(imgObj)" /><br>
</form>
<div id="output"></div>
