...
<br>
<div id="subcontent">
<p><h2>Procedure to change the contrast: </h2>
	<br>1. Choose an image file first..<br>
	<br>2. Select your image and then click on upload.<br>
	<br>3. Adjust your contrast range.<br>
	<br>4. Click on Change Contrast button to see the effects.<br>
...
-webkit-appearance: slider-horizontal" min="-50" max="50" id="kkk" value="0" step="10" onchange="channel(imgObj)" />
 <form>
 	<span class="file-wrapper">
