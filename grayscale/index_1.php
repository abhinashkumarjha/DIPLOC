...
<br>
<div id="subcontent">
<p><h2>Procedure to perform conversion: </h2>
	<br>1. Click on choose file.<br>
	<br>2. Select your image and then click on upload.<br>
	<br>3. Press the greyscale button then.<br>
	<br>4. To start a fresh operation click on Reset button </p>
</div>
<br>
<br>
<div align="center">
