...
<link href="style/style_choose.css" rel="stylesheet" type="text/css" />
...
<br>
<div id="subcontent">
<p><h2>Procedure to vary brightness: </h2>
	<br>1. Choose an image file first.<br>
	<br>2. Select your image and then click on upload.<br>
	<br>3. Adjust your brightness range.<br>
	<br>4. Click on Brighten Image button to see the effects.<br>
...
-webkit-appearance: slider-horizontal" min="-50" max="50" id="kkk" value="0" step="10" onchange="channel(imgObj)" /><br>
 	<span class="file-wrapper">
 	<input id="toggleDesaturate" name="apply_effect" value="APPLY EFFECT" type="button"  onClick="channel(imgObj)"><br>
