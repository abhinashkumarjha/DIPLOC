...
<script> 
       $(document).ready(function(){
        $('#toggleDesaturate').click(function(){
            ...
            if($.browser.msie){
                brightenImageIE(imgObj);
            } else {
                imgObj.src = brightenImage(imgObj);
            }           
        });
    });
...
var amount=kkj.value;
        ...
        for(var y = 0; y < imgPixels.height; y++){
            for(var x = 0; x < imgPixels.width; x++){
                ...
                var b1 = ((imgPixels.data[i])+parseInt(amount));
			    var b2 = ((imgPixels.data[i+1])+parseInt(amount));
				var b3 = ((imgPixels.data[i+2])+parseInt(amount));
                imgPixels.data[i] = b1; 
                imgPixels.data[i + 1] = b2; 
                imgPixels.data[i + 2] = b3;
